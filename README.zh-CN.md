...
![Codex Switch Helper 产品截图](docs/promo/dashboard-watermarked.png)
...
- Skills 页面显示版本、更新时间、本地推算的使用次数和最近使用时间，支持排序、按来源检查更新和保护性删除；自动导入只补充缺失内容，不覆盖同名共享 Skill。
- Plugins 页面显示版本、更新时间、实际工具调用次数和最近使用时间，支持排序、按来源检查更新和保护性删除，并自动把共享版本同步回全部托管 Profile。
